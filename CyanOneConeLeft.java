...
public class CyanOneConeLeft extends LinearOpMode {
    OpenCvCamera camera;
...
// free NBA Yungboy
        ...
        if(tagOfInterest==null || tagOfInterest.id==left){
            ...
            Trajectory left9 = drive.trajectoryBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-5,-4,Math.toRadians(-32)))
            ...
            Trajectory left1 = drive.trajectoryBuilder(new Pose2d())
                    ...
                    .build();
            Trajectory left9 = drive.trajectoryBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-5,-4,Math.toRadians(-31)))
            ...
            Trajectory left4 = drive.trajectoryBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-12, -5, Math.toRadians(33)))
            ...
            Trajectory left1 = drive.trajectoryBuilder(new Pose2d())
                    ...
                    .build();
            Trajectory left9 = drive.trajectoryBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-5,-4,Math.toRadians(-28)))
            ...
            Trajectory left4 = drive.trajectoryBuilder(new Pose2d())
                    .forward(19)
                    .build();
            TrajectorySequence leftturn3 = drive.trajectorySequenceBuilder(new Pose2d())
